...
public class Probabilidade {
    public static void main(String[] args) {
        ...
        System.out.println("Primitivo: Probabilidade de pelo menos uma pessoa acertar os 15 números: "
        + probabilidadeDeAcertarPeloMenosUm);
        
        System.out.println();
        
        // Imprimindo a variável probabilidadeDeAcertarPeloMenosUm no tipo wrapper Double
        System.out.println("Wrapper: Probabilidade de pelo menos uma pessoa acertar os 15 números: "
        + Double.valueOf(probabilidadeDeAcertarPeloMenosUm));
    }
}
